...
// Initialize all systems with progressive loading
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Phase 1: Initialize critical UI immediately
    new ScrollReveal();
    
    // Phase 2: Load particles after a short delay (user sees the page first)
    setTimeout(() => {
        new QuantumParticleSystem('quantum-particles');
    }, 100);
    
    // Phase 3: Load visual effects after content is visible
    setTimeout(() => {
